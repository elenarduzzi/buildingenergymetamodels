# assigns surface types to surface geometry from input json
# loops for multiple input files within folder 

import json
import os

# paths
INPUT_JSON = "1B_pand_jsons_21"
OUTPUT_JSON = "2B_pand_surfaces_21_EPLUS"
...
# ground floor = minimum of all z cooridnates
# roof = maximum all z coordinates
# else = wall
...
# process multiple input files in the folder 

for filename in os.listdir(INPUT_JSON):
    if filename.endswith(".json"):
        input_path = os.path.join(INPUT_JSON, filename)
