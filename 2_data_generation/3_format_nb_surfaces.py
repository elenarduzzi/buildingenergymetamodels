...
- Transform local vertex data in mm to absolute RD new metres
- Classify each surface G / F / R
- For each building save the newly formatted JSON file
"""
...
MAPPING_FILE = pathlib.Path(r"C:\pand_arch_map_21.json")
